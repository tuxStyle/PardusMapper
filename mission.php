...
$rank = 0;
if (isset($_SESSION['rank'])) { $rank = $db->real_escape_string($_SESSION['rank']); }

$comp = 0;
if (isset($_SESSION['comp'])) { $comp = $db->real_escape_string($_SESSION['comp']); }

$faction = 0;
if (isset($_SESSION['faction'])) { $faction = $db->real_escape_string($_SESSION['faction']); }
...
if (isset($_REQUEST['x1']) && isset($_REQUEST['y1'])) {
	$x1 = $db->real_escape_string($_REQUEST['x1']);
	$y1 = $db->real_escape_string($_REQUEST['y1']);
